...
describe("IndexPage", () => {
  it("renders the homepage with all main sections", () => {
    ...
    expect(screen.getByTestId("featured-posts")).toHaveAttribute(
      "data-title",
      "Posts em Destaque"
    )
    ...
    expect(screen.getByTestId("recent-posts")).toHaveAttribute(
      "data-title",
      "Últimos Posts"
    )
    expect(screen.getByTestId("recent-posts")).toHaveAttribute(
