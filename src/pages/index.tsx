...
import WideLayout from "../components/organisms/WideLayout"
import SEO from "../components/atoms/SEO"
import Button from "../components/atoms/Button"
import PostCarousel from "../components/organisms/PostCarousel"
...
const IndexPage: React.FC<IndexPageProps> = ({ data, location }) => {
  ...
  return (
    <WideLayout location={location} title={siteTitle}>
      <SEO
        title="Home"
