...
date: "2023-12-10"
description: "Discussões sobre os limites éticos do uso de IA"
featuredImage: frankenstein.webp
---

## O dia do julgamento

A cultura pop nos trouxe diferentes histórias de um evolução tecnológica em que
as máquinas se tornam conscientes e vejam a humanidade como uma ameaça. Esse é o
...
Após perceberem os riscos da Skynet, os cientistas decidiram desligá-la. Como
forma de retaliação ou defesa, o sistema autônomo disparou mísseis nucleares
...
A estória descrita anteriormente é uma síntese de vários enredos de um momento
histórico conhecido como Guerra Fria. Falando sobre o século _XX_ , voltemos um
...
teoria, haveria uma chance remota de uma bomba atômica iniciar uma ignição
...
**Qual é o limite (ético) para o teste/evolução de uma nova tecnologia?**
...
Apesar de certa desconfiança de alguns (inclusive eu), o uso de ferramentas de
inteligência artificial me parece um caminho sem volta. Todavia, a discussão
...
ilustração do clássico _Frankenstein_, de Mary Shelley, foi 
...
Em alguns processo seletivos para vagas em tecnologia é comum que o candidato
possa "levar uma tarefa para casa". No papel de avaliador, deveríamos considerar
...
(_data-driven_) que utiliza IA para definir alvos em Gaza que mitigue o número
de vítimas civis[^3]. No contexto de uma guerra, uma visão tecnocrata poderia
...
parâmetros que traz em si todo enviesamento intrínseco a qualquer humano. O fato
...
ficção, podemos considerar que exemplos como o _The Gospel_ demostra a
importância de discutimos a abrangências dos sistemas que utilizam IA,
especialmente em tomadas de decisão. Se partirmos da premissa que os resultados
fornecidos por esse tipo de ferramenta como uma verdade absoluta e neutra,
podemos nos tornar mera engrenagens em decisões humanas complexas. Pode ser que
dessa vez a atmosfera vai incendiar.
