...
A cultura pop é recheada de histórias sobre uma evolução tecnológica permitiria
que as máquinas se tornam conscientes. Nesse processo evolucionário, o próximo
passo consistiria nas máquinas percebendo a humanidade como uma ameaça. Esse é o
enredo, por exemplo, da franquia _Exterminador do Futuro (Terminator)_ que nos
apresenta a [Skynet](https://terminator.fandom.com/wiki/Skynet), uma
