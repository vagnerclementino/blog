...
é o limite (étnico) para o teste/evolução de uma nova tecnologia?**
...
inteligência artificial me parece um caminho sem volta. Todavia, a discussão sobre
os parâmetros éticos que governam esse tipo de ferramenta necessitam ser
...
ter utilizado o suporte de ferramentas de IA. A justificativa foi que _“as
regras da premiação estabelecem que casos não previstos no regulamento sejam
...
(_data-driven_) que utiliza IA para definir alvos em Gaza que mitigue o número de
vítimas civis[^3]. No contexto de uma guerra, uma visão tecnocrata poderia
...
abrangências dos sistemas que utilizam IA, especialmente em tomadas de decisão.
...
engrenagens em decisões humanas complexas. Pode ser que dessa vez a atmosfera
vai incendiar.
