...
próximo passo consistiria nas máquinas percebendo a humanidade como uma ameaça.
...
após o fim da Segunda Guerra Mundial. Contudo, voltemos exatamente para o
período da Segunda Guerra, especialmente nos dias em que muitos homens e
...
parágrafos podem revelar alguns _spoilers_**.
...
já fazem parte do ecossistemas de muitos desenvolvedores, aumento a quantidade
de código produzido, reduzindo o número de  tarefas repetitivas e facilitando a
...
Em alguns processo seletivos para a area de desenvolvimento, é bastante comum
que o candidato possa "_levar uma tarefa para casa_". No papel de avaliador,
deveríamos considerar as soluções que utilizem algum suporte de IA? Como podemo
...
para definição de alvos de guerra. **O ponto é que justamente essas ferramentas
possuem vieses**.
...
vive ou quem morre é assustador. Bem mais do que uma eventual Skynet. Existe o
real perigo de consideramos tais tomadas de decisão como neutras e percamos a
