...
Este artigo explora como desenhar uma API como produto, utilizando o ciclo de
vida proposto em nossa recente apresentação na conferência de desenvolvimento
de software.
...
uma API "_é uma maneira para dois ou mais programas de computador ou
...
![Imagem representando uma construção grega em as plavras Application
Programming Interface estão escritas em três columas para dar idéia de que cada
palavra do termo API devem ser consideras de forma equivalente no entendimento
dessa tecnologia](./api-columns.png)
...
Os exemplos descritos anteriormente demostram a versatilidade e a ubiquidade
das APIs na tecnologia atual. Contudo, para essa apresentação podemos
considerar API como sinônimo de API Remotas.Segundo um relatório da empresa
responsável pela ferramenta Postman, cerca de 86% dos desenvolvedores utilizam
API REST[^2].


![Imagem das principais Api Remotas ou Web APIs: GraphQL, REST, WebSockets,
...
**Ferramentas para Design:**
 ...
 - **Prism**: Ferramenta para mockar APIs baseadas em OpenAPI/Swagger, útil
...
Os testes garantem a corretude e a integridade da API. Incluem testes de
...
**Ferramentas para Testes:**
 ...
 - **Vegetta**: Outra ferramenta para testes de carga.
...
**Ferramentas para Publicação:**
 ...
 - **GCP Apigee** e **AWS API Gateway**: Plataformas para publicar, proteger e
   monitorar APIs.
...
| Vegetta | Testes | https://github.com/tsenart/vegeta |
| SOAPUI | Testes | https://www.soapui.org/ |
| GCP Apigee | Publicação | https://cloud.google.com/apigee |
